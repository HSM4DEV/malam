...
export const metadata: Metadata = {
  title: "مشروع جديد · لوحة تحكم الوسيط · مَعلم",
};

export default function NewBrokerProjectPage() {
  return (
    <>
      <DeveloperTopbar eyebrow="محفظتك العقارية" title="مشروع جديد" searchPlaceholder="بحث…" />
      <div className="px-8 py-7">
        <ProjectForm action={createProjectAction} returnTo="/dashboard/broker/projects" />
      </div>
    </>
  );
}
